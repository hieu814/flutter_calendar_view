...
import '_internal_custom_day_view_page.dart';
...
class CustomDayView<T extends Object?> extends StatefulWidget {
  ...
  /// Style for CustomDayView header.
...
class CustomDayViewState<T extends Object?> extends State<CustomDayView<T>> {
                    ...
                    child: PageView.builder(
                      ...
                      itemBuilder: (_, index) {
                        ...
                        return ValueListenableBuilder(
                          ...
                          builder: (_, __, ___) => InternalCustomDayViewPage<T>(
                            key: ValueKey(
  ...
  void _setWeekDays() {
    ...
    assert(
        ...
        "CustomDayView. or showWeekends is true if you are providing only "
  ...
  ///
  /// Arguments [duration] and [curve] will override default values provided
  /// as [CustomDayView.pageTransitionDuration] and [CustomDayView.pageTransitionCurve]
  /// respectively.
